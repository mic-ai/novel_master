    ...
    <div className="w-full max-w-md">
      <div className="bg-white rounded-2xl shadow-xl shadow-indigo-100 border border-indigo-50 p-8 space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-gray-900">小説制作サポートエージェント</h1>
          <p className="text-gray-500 text-sm">ログインして執筆を始めましょう</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-700 font-medium hover:border-gray-300 hover:bg-gray-50 transition"
            >
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-gray-900 text-white rounded-xl font-medium hover:bg-gray-800 transition"
            >
